...
for opinion in opinions:
    all_opinions.append()
    single_opinion = {
        'opinion-id':opinion['data-entry-id'],
        'author':opinion.select_one('span.user-post__author-name').text.strip(),
        'recomendations':opinion.select_one('span.user-post__author-recomendation > em').text.strip(),
        'score':opinion.select_one('span.user-post__score-count').text.strip(),
        'purchased':opinion.select_one('div.review-pz').text.strip(),
        'published_at':opinion.select_one('span.user-post__published > time:nth-child(1)').text.strip(),
        ...
        'contenrt':opinion.select_one('div.user-post__text').text.strip(),
